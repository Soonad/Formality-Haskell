...
notcontractible1 = Mu "X" (Lam "a" Typ (App (Var 1) (Var 0)))
notcontractible2 = Mu "X" (App (Lam "a" Typ (Var 0)) (Var 0))
...
evalBohm term = case term of
  ...
  App f a   -> let a' = evalBohm a in
    case evalBohm f of
      Mu n t@(Lam _ _ _) ->
        case a' of
          Var _ -> App (Mu n t) a'
          _     -> evalBohm $ App (subst t (Mu n t) 0) a'
...
double = Mu "double" (Lam "n" Any (App (App (Var 0) zero) (Lam "x" Any (App suc (App suc (App (Var 2) (Var 0)))))))
